...
이 저장소는 음성을 사용자 인터페이스로 사용하는 애플리케이션에서 RAG 지원을 구현하는 방법의 예제를 포함하고 있으며, GPT-4o 실시간 API를 통해 제공됩니다. 우리는 이러한 패턴을 좀 더 자세히 이 블로그 게시물에서 설명하며, 이 짧은 비디오에서 이 샘플 앱의 작동 모습을 볼 수 있습니다.
